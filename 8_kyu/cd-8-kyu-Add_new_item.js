...
(This Kata is originally designed for C# language and it shows that adding a new item to the input
list is not going to work, even though the parameter is passed by value,
but the value is poining to the reference of list and any change on parameter will be seen by caller)

Link: https://www.codewars.com/kata/566dc05f855b36a031000048/train/javascript
